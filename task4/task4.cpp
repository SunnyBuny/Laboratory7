...
int main() {
	...
	{
		while (num1.length() != num2.length()) num2.insert(0, 1, '0'); // если длина первого числа больше второго, дополнить второе нулями
	}
	else if (num1.length() < num2.length())
	{
		while (num1.length() != num2.length()) num1.insert(0, 1, '0'); // если длина второго числа больше первого, дополнить первое нулями
	}
